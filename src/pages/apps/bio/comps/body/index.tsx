...
const BioBody: React.FC<Props> = ({ state, dispatch }) => {
  ...
  return (
    ...
    >
      ...
      <Text mb="24px">
        skills {"->"} react, redux, hooks+context, vue, vuex, angular, NgRx,
        typeScript, next, swr, react-native, webassembly, node, express, jwt &
        bcrypt for auth, mongo, redis, graphql, socket, materialUI, bootstrap,
        styled-components, pug, HTML/CSS/SCSS
      </Text>
      <Text mb="24px">
        About me {"->"} I graduated from university late, i had a health
        problem. I worked at the factory for one year, but i wanted to quit my
        job to advance my career in software.
      ...
      <Text mb="24px">
        About this website {"->"} designed by Bill Gates, developed by me. I
        used react in the front-end. I used typescript, react hooks and context,
        scss and styled - components in this website.
        <br />
        Todo;
        <br />
